...
\\[2pt]
\scriptsize {\lolit Slides:} \href{http://bit.ly/Memphis2016}{\tt \scriptsize
  \color{foreground} bit.ly/Memphis2016}
}
...
\frame{
  ...
  \note{These are slides for a talk that I gave at the University of
    Tennessee Health Science Center in Memphis, Tennessee, on 9 Nov 2016.

    Source: {\tt https://github.com/kbroman/Talk\_Rqtl2} \\
    Slides: {\tt http://bit.ly/Memphis2016}
}
} }
